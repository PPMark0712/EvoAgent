...
def main(args):
    target_file = os.path.join(args.workspace_path, "roster_clean.xlsx")
    gold_file = os.path.join(args.gold_path, "roster_clean.xlsx")
    evaluator = Evaluator("data_cleaning/task_003_standardize_headcount_export", target_file, gold_file)
