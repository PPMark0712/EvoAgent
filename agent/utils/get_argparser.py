...
def get_argparser(parser: argparse.ArgumentParser | None = None) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--model", type=str, default="qwen3.5-flash", help="Model name or path for WorkerNode")
    ...
    parser.add_argument("--loop_input", action="store_true", help="Use loop input provider instead of prompting.")
